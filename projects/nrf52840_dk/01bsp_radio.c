...
//#define LENGTH_PACKET   0x17+LENGTH_CRC//125+LENGTH_CRC  ///< maximum length is 127 bytes
//#define LEN_PKT_TO_SEND 0x17+LENGTH_CRC//20+LENGTH_CRC
...
//    while (1) {
//        app_vars.flags=APP_STATE_RX; //FOR task:Generate an ibeacon packet using the BLE mode
...
//                    memcpy(app_vars.packet, m_beacon_info, APP_BEACON_INFO_LENGTH);
//                    //i = 0;
//                    //app_vars.packet[i++] = 't';
//                    //app_vars.packet[i++] = 'e';
//                    //app_vars.packet[i++] = 's';
...
//                    radio_ble_loadPacket(app_vars.packet,LEN_PKT_TO_SEND);
//                    radio_txEnable();
//                    radio_txNow();
